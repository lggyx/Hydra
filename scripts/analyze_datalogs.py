#!/usr/bin/env python3
"""
Hydra Datalog Analyzer — Post-hoc evaluation of agent performance.
...
def format_report(analyses: list) -> str:
    ...
    lines = []
    lines.append("# Hydra Evaluation Report\n")
...
DEEP_ANALYSIS_PROMPT = """You are evaluating an AI coding agent called "hydra".
...
3. Suggest ONE specific, actionable improvement to hydra's framework or system prompt.
