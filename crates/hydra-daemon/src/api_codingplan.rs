...
use hydra_core::auth;
use hydra_core::coding_plan;
use hydra_telemetry::{CodingplanErrorKind, CodingplanResult, Event};
...
pub(crate) async fn codingplan_setup(
    ...
    axum::Extension(client_mode): axum::Extension<hydra_telemetry::SessionMode>,
