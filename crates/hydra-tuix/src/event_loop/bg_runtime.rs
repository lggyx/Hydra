use hydra_core::agent::{AgentClient, AgentEvent};
...
fn test_client() -> AgentClient {
    ...
    AgentClient {
        cmd_tx,
        tool_registry: std::sync::Arc::new(hydra_core::tool::ToolRegistry::new()),
        skill_registry: std::sync::Arc::new(std::sync::RwLock::new(
            hydra_core::skill::SkillRegistry::new(),
        )),
    }
}
...
mod tests {
    use super::*;
    use hydra_core::session::Session;
    ...
    fn render_empty_bg_list_mentions_no_background_sessions() {
        ...
        crate::i18n::set_locale(hydra_core::locale::Locale::En);
    ...
    fn background_turn_complete_updates_slot_to_done_and_messages() {
        use hydra_core::agent::TurnStopReason;
    ...
    async fn runtime_event_forwarder_tags_events() {
        use hydra_core::agent::AgentEvent;
