...
Plugins are installable collections of skills, commands, agents, and hooks. Hydra supports plugin installation to extend functionality.
...
|--------|----------|--------------|
| **hydra** | Hydra usage & documentation Q&A | Offline docs index, install/config/troubleshooting answers, `/skills ask` command |

### Development & Code Quality

| Plugin | Best For | Key Features |
|--------|----------|--------------|
| **plugin-dev** | Building Hydra plugins | Skills for creating skills, hooks, commands, agents |
...
|-----------------|-------------------|
| Any project (first-time setup) | hydra |
...
- User wants to install Hydra automations from a shared repository
- User needs multiple related capabilities
- Team wants standardized workflows
- First-time Hydra setup
