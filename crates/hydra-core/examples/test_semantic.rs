use hydra_core::semantic::SemanticSearcher;
use std::path::Path;
...
fn main() {
    ...
    let path = Path::new("crates/hydra-core/src/tool/mod.rs");
    ...
    let agent_path = Path::new("crates/hydra-core/src/tool/bash.rs");
    ...
    let big_path = Path::new("crates/hydra-core/src/tool/bash.rs");
    ...
    let agent_path = Path::new("crates/hydra-core/src/agent/mod.rs");
