// crates/hydra-core/src/coding_plan/types.rs
//
...
/// omits a key still deserialises (hydra falls back to the
...
/// `is_infinity` and `is_hydra_exclusive` are flagged
...
pub struct ModelEntry {
    ...
    /// metadata; hydra doesn't act on it — `plan_available`
