// crates/hydra-core/src/coding_plan/mod.rs
//
...
// both `hydra codingplan` (CLI subcommand) and `/codingplan` (TUI
...
// configurable via `HYDRA_CODINGPLAN_API_BASE`. The shared UA
// (`HYDRA_USER_AGENT`) is honoured by every request so AtomGit's
// API gateway sees a consistent `hydra/<ver>` identifier.
