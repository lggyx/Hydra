...
mod tests {
    ...
    fn parses_canonical_url() {
        let r = IssueRef::parse("https://atomgit.com/atomgit_atomcode/hydra/issues/42").unwrap();
        assert_eq!(r.owner, "atomgit_atomcode");
        assert_eq!(r.repo, "hydra");
    ...
    fn parses_gitcode_mirror_issue_url() {
        let r = IssueRef::parse("https://gitcode.com/atomgit_atomcode/hydra/issues/340")
            .unwrap();
        assert_eq!(r.owner, "atomgit_atomcode");
        assert_eq!(r.repo, "hydra");
    ...
    fn parse_repo_url_strips_user_only_userinfo() {
        ...
        let r = parse_repo_url("https://alice@gitcode.com/atomgit_atomcode/hydra").unwrap();
        assert_eq!(r.owner, "atomgit_atomcode");
        assert_eq!(r.repo, "hydra");
    }
    ...
    fn parse_repo_url_accepts_gitcode_mirror() {
        ...
        // remote (e.g. `git@gitcode.com:atomgit_atomcode/hydra.git`)
        ...
        for url in [
            "git@gitcode.com:atomgit_atomcode/hydra.git",
            "https://gitcode.com/atomgit_atomcode/hydra.git",
            "https://gitcode.com/atomgit_atomcode/hydra",
            "ssh://git@gitcode.com/atomgit_atomcode/hydra.git",
        ] {
