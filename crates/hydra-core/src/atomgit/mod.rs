...
/// Owner of the hydra upstream repo on atomgit.com. Used by `/issue`
/// to file bug reports / feature requests against hydra **itself** —
...
/// Name of the hydra upstream repo. Keep in sync with the
/// `repository` field in the workspace `Cargo.toml`.
pub const UPSTREAM_REPO: &str = "hydra";
