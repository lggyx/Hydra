...
pub(super) fn en(msg: Msg<'_>) -> Cow<'static, str> {
    match msg {
        Msg::WelcomeBannerLine1 =>
            "Welcome to Hydra. Pick an option to get started:".into(),
        ...
        Msg::CpOfficialBuildRequired => Cow::Borrowed(
            "This feature requires the official Hydra build. Download it from \
             https://atomgit.com/atomgit_atomcode/hydra/releases.",
        ),
        Msg::CpAuthRequired => Cow::Borrowed(
            "Not signed in to Hydra CodingPlan. Run /login to sign in \
        ...
        Msg::CpSignVersionTooOld => Cow::Borrowed(
            "Hydra is out of date and no longer compatible with CodingPlan. \
             Please upgrade Hydra to continue.",
        ),
        Msg::CpUpgradeRequired => Cow::Borrowed(
            "An upgrade is required to continue using CodingPlan. \
             Please install the latest Hydra from the official releases.",
        ),
  ...
  ── Input ──
    ...
    \ then Enter                     Insert newline (hydra fallback, universal)
  ...
  ── Scrollback ──
    ...
    Drag + Ctrl+C                    Copy text (hydra does not capture the mouse)
...
"#.into(),
        ...
        Msg::McpReloadFailed { error } =>
            format!("mcp reload failed: failed to load .mcp.json / $HYDRA_HOME/mcp.json: {:#}", error).into(),
        // /mcp login / logout
        ...
        Msg::HelpCustomCreateHint =>
            "  Create: ~/.hydra/commands/<name>.md or .hydra/commands/<name>.md\n".into(),
...
"Scan project, install seeds, and run setup skill [hooks|mcp|skills|all]".into(),
        ...
        Msg::CmdDescReload => "Reload $HYDRA_HOME/config.toml from disk".into(),
        Msg::CmdDescCd => "Change working directory".into(),
Msg::CmdDescInit => "Generate .hydra.md project instructions from the working directory".into(),
...
Msg::CmdDescBackground => "Run a one-shot task in an isolated background context (read-only-ish tool subset)".into(),
        ...
        Msg::CmdDescUpgrade => "Upgrade hydra to latest (subcommand: rollback)".into(),
        Msg::CmdDescIssue => "Report a bug / request a feature for Hydra itself (interactive wizard)".into(),
        ...
        Msg::CmdDescQuit => "Exit Hydra".into(),
        ...
        Msg::OnboardingPanelTitle => "Hydra".into(),
