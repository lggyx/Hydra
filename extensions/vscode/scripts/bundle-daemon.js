...
const targets = [
  { id: 'darwin-arm64', exe: 'hydra-daemon', env: 'HYDRA_DAEMON_DARWIN_ARM64' },
  { id: 'darwin-x64', exe: 'hydra-daemon', env: 'HYDRA_DAEMON_DARWIN_X64' },
  { id: 'linux-x64', exe: 'hydra-daemon', env: 'HYDRA_DAEMON_LINUX_X64' },
  { id: 'linux-arm64', exe: 'hydra-daemon', env: 'HYDRA_DAEMON_LINUX_ARM64' },
  { id: 'win32-x64', exe: 'hydra-daemon.exe', env: 'HYDRA_DAEMON_WIN32_X64' },
];
...
function sourceFor(target) {
  ...
  if (target.id === currentTargetId()) {
    const localExe = process.platform === 'win32' ? 'hydra-daemon.exe' : 'hydra-daemon';
