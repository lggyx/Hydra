...
```bash
curl -fsSL https://github.com/lggyx/Hydra/releases/download/{tag_name}/install.sh | sh
```

Windows PowerShell:

```powershell
irm https://github.com/lggyx/Hydra/releases/download/{tag_name}/install.ps1 | iex
```
